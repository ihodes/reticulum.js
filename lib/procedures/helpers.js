...
function ProcedureError(procedureName, message) {
    this.type     = "ProcedureError";
    this.name     = procedureName;
    this.message  = message;
}
ProcedureError.prototype = new Error();
ProcedureError.prototype.constructor = ProcedureError;
...
var reifyParam = function(context, param) {
    ...
    if (_.isArray(param)) { // then we need to join it
        ...
        return reifyObject(context, param);
...
_.extend(exports, {setIn: setIn, deleteIn: deleteIn,
                   ...
                   reifyParam: reifyParam, ProcedureError: ProcedureError});
