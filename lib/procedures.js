...
// All procedures get treated the same way;  They are curried functions
...
// 
// procedures are passed, in order, locals, userContext, eventName, eventArgs, res
...
exports.PROCEDURES = {
    ...
    'push': function(locals, userContext, eventName, eventArgs) {
        return function(deviceToken, message) {
            ...
            var user = locals.urbanAirshipKey    || userContext.urbanAirshipKey;
            var pass = locals.urbanAirshipSecret || userContext.urbanAirshipSecret;
            var auth = { user: user,
                         pass: pass };
